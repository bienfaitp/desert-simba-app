...
export default function App() {
  ...
  // Close the drawer on Escape, and never leave it open behind a resize.
  useEffect(() => {
        ...
        <>
          ...
          <nav className="drawer" aria-label="Main navigation">
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "4px 4px 14px" }}>
              <Logo h={36} />
              <button className="navitem" onClick={() => setDrawer(false)} aria-label="Close menu"
                style={{ width: "auto", padding: 8 }}><X size={20} /></button>
            </div>
            {navList}
          </nav>
        </>
