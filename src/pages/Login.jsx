...
export default function Login() {
  ...
  async function submit(e) {
    ...
    try {
      if (mode === "signup") {
        ...
        setMsg({ ok: true, text: "Account created. If email confirmation is on, check your inbox — otherwise you're in." });
      } else {
  ...
  return (
    <div className="auth">
      <div className="box">
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 18 }}><Logo h={96} /></div>
        <div className="card">
          ...
          <p className="muted" style={{ fontSize: 14, marginBottom: 18 }}>
            {mode === "signup" ? "The first account created becomes the club admin." : "Sign in to your club portal."}
          </p>
