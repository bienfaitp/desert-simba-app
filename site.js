...
// Honest "coming soon" list — features the club plans but that aren't built yet.
import { CreditCard, QrCode, Radio, Network } from "lucide-react";
export const COMING_SOON = [
  { icon: CreditCard, label: "Online payments" },
  { icon: QrCode, label: "QR check-in" },
  { icon: Radio, label: "Live match scoring" },
  { icon: Network, label: "Tournament brackets" },
];
